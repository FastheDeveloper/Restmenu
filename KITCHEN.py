...
f1 = Frame(parent, bd=10, width=1350, height=1000, bg="light blue", relief=RIDGE, highlightbackground="black")
...
def cost():
    ...
    v1.set(f1*700.00 + f2*600 +f3*1500 + f4*100+ f5*700 + f6*300 + f7*200 + f8 * 100 + f9 * 100 + f10 * 50 + f11 * 100 +
...
x = Label(f5, text="Payment Method ", bg="light blue", fg="steel blue", font=fnt).grid(row=0, column=0)
dp = ["Cash", "Bank Transfer", "Point of sales"]
x1 = ttk.Combobox(f5, height=3, values=dp, state="readonly")
x1.set("Pick an option")
x1.grid(row=0, column=1)

x2 = Button(f5, text="Total $", bg="light blue", fg="steel blue", activebackground="light blue", command=lambda:cost(), width=5, font=fnt, relief=RIDGE)
x2.grid(row=2, column=0, sticky=W)

display = Entry(f5, font=fnt, width=15, bd=2, justify="right", textvariable=v1, state=DISABLED, relief=SUNKEN)
...
ap = Entry(f5, textvariable=p1, width=20, bd=2, justify="left", state=NORMAL, relief=SUNKEN)
ap.grid(row=3, column=1, sticky=E)

x3 = Button(f5, text="Reset", bg="light blue", activebackground="light blue", fg="steel blue", command=reset, width=5,
            font=fnt, relief=RIDGE)
x3.grid(row=2, column=2)

x4 = Button(f5, text="Exit", bg="light blue", activebackground="light blue", fg="steel blue", width=5,
            command=lambda: Exit(), font=fnt, relief=RIDGE)
x4.grid(row=5, column=2)

change_butt = Button(f5, text="Change Due", bg="Light blue", fg="steel blue", activebackground="light blue", width=10,
                     font=fnt, relief=RIDGE)
change_butt.grid(row=4, column=0, sticky=W)
...
print_receipt = Button(f5, text="Print Receipt", width=12, fg="steel blue", bg="light blue",
